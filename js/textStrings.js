...
var textStrings_VI = {
// Act 1
"niceHat": "Đù! Cái mũ đẹp đấy =))",
"outtaHere": "ờm.. hãy ra khỏi đây!!",
"getARoom": "Hãy... LẤY PHÒNG!!",
"notCoolAnymore": "uhhh... đừng bận tâm, mũ không ngầu nữa..",
"tvOnTv": "vãi!! TV TRONG TV!!",
"cricky": "Nhỏ nhắn <3",
"tooManyCrickets": "được rồi, có quá nhiều dế...",
"normalPeep": "chỉ là một người bình thường..",
"normalPeeps": "chỉ là một số người bình thường..",
"wowNothing": "ồ wowoeowow, chả có đếch gì :))",

// Act 2
"crazySquareAttacks": "CÁC CUỘC TẤN CÔNG CỦA TRÒN ĐIÊN RỒ",
"justMissed": "ahh hụt nữa kìa",
"somethingInteresting": "(bạn phải bắt gặp họ đang làm *điều gì đó* thú vị...)",
"whoIsScreaming": "(bạn phải bắt được ai đang hét vào mặt họ)",
"circleFearsSquares": "VÒNG TRÒN SỢ HÃI HÌNH VUÔNG",
"whoScaresThem": "(bạn cũng phải biết họ sợ *ai* chứ)",
"areTheyScared": "(bạn phải bắt gặp cảnh họ *bị* một hình vuông làm sợ)", // not used
"squaresSnubCircles": "VUÔNG BỎ QUA THẰNG TRÒN",
"areTheySnubbed": "(bạn phải bắt được chúng *trong khi* phớt lờ một thằng tròn)", // not used
"everyoneHates": "Kh thể nào.. mọi người đã GHÉT nhau!!1!",
"almostEveryoneHates": "MỌI NGƯỜI SẮP GHÉT NHAU...",
"squaresHateCircles": "THẰNG VUÔNG GHÉT THẰNG TRÒN",
"circlesHateSquares": "THẰNG TRÒN GHÉT THẰNG VUÔNG",
"areTheyYelling": "(bạn phải bắt chúng *la hét* vào những người khác)", // not used
"nerdsNow": "những kẻ mọt sách này đang làm gì bây giờ",
"schockedPeep": "Tại sao th này lại bị sốc thế?",
"whatever": "sao cũng được",

// Act 3
"ellipsis": ". . .",
"coolNoMore": "Mũ không còn ngầu nữa rồi, bạn có nghe nói không?",
"beScared": "SỢ HÃI. TỨC GIẬN.",

// MANIFESTO
"manifesto": [
//"as if you viewers want GOOD news"       ,
"ai theo dõi để xem *mọi người hòa thuận với nhau?*",
"hòa bình thì nhàm chán. bạo lực lan truyền.",
//"peace is boring. conflict gets clicks." ,
"và mọi câu chuyện đều cần có xung đột, vì vậy...",
//"...GIVE THE AUDIENCE WHAT THEY WANT."   ,
"CUNG CẤP CHO KHÁN GIẢ NHỮNG GÌ HỌ MUỐN."
],
...
// (chyron3.png)
"chyronNothing": "WOWWEE, KHÔNG CÓ GÌ CẢ",

// (credits0001.png)
"createdBy": "được tạo ra bởi",
"NickyCase": "Nicky Case",

// (credits0002.png)
"manyThanks": "Cảm ơn rất nhiều những người chơi thử nghiệm của tôi:",

// (credits000[3,4,5,6].png)
"patreonSupporters": "và gửi đến những người ủng hộ tôi trên Patreon:",

// (credits0007.png)
"lastButNotLeast": "và cuối cùng nhưng không kém phần quan trọng,",

// (credits0008.png)
"thankYouForPlaying": "Cảm ơn bạn đã chơi! Dịch bởi tienanh109!",
...
"buyCoffeeButton": "mua 1 cốc cafe cho tôi",
...
// (end_prototype.png)
"endOfPrototype": "KẾT THÚC NGUYÊN MẪU",
"toBeContinued": "(còn nữa...)",

// (quote0002.png)
"WBWWB": "Chúng ta trở thành những gì chúng ta nhìn thấy.",
"WSOTATOTSU": "Chúng ta định hình công cụ của mình và sau đó công cụ lại định hình chúng ta.",

// (quote0003.png)
"MarshallMcLuhan": "Marshall McLuhan",

// (quote0004.png)
"misatrributed": "(ghi sai)",
};
